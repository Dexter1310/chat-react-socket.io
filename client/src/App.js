            ...
            <div className="container mt-3">
              <div className="card shadow border-0">
                <div className="card-body">
                  {nickname !== '' ?
                      <form onSubmit={deleteNickSubmit}>
                        <div className=" text-end m-1">
                          {/*<input value={e=>setNickname(e.target.value)} type="hidden" />*/}
                          <button className="btn btn-danger mx-3 btn-sm"
                                  id="btn-logout" type="submit">Salir
                          </button>
                        </div>
                      </form> : null
                  }
